...
JOINT_REGRESSOR_TRAIN_EXTRA = osp.join(AnimateLy_DATA_DIR, 'J_regressor_extra.npy')
SMPL_MEAN_PARAMS = osp.join(AnimateLy_DATA_DIR, 'smpl_mean_params.npz')
SMPL_MODEL_DIR = AnimateLy_DATA_DIR
